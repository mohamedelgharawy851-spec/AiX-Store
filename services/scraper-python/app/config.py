...
SERVICE_HOST = os.environ.get("SHOPEASE_PYTHON_HOST", "127.0.0.1")
SERVICE_PORT = int(os.environ.get("SHOPEASE_PYTHON_PORT", "8790"))
...
AUTH_TOKEN_TTL_SECONDS = int(os.environ.get("SHOPEASE_AUTH_TOKEN_TTL_SECONDS", "2592000"))
PASSWORD_HASH_ITERATIONS = int(os.environ.get("SHOPEASE_PASSWORD_HASH_ITERATIONS", "240000"))
CATEGORY_STRICT_SCORE_THRESHOLD = 4.0
CATEGORY_SCORE_MARGIN = 2.0
STRONG_SEARCH_RESULT_THRESHOLD = 8
MAX_QUERY_VARIANTS = 5

PROXY_URL = os.environ.get("SHOPEASE_PROXY_URL", "").strip() or None
TARGET_PRIMARY_STORE_ID = os.environ.get("SHOPEASE_TARGET_STORE_ID", "1056")
TARGET_PURCHASABLE_STORE_IDS = os.environ.get(
    "SHOPEASE_TARGET_STORE_IDS",
    "1056,1508,2158,1474,1845",
)
TARGET_STORE_ZIP = os.environ.get("SHOPEASE_TARGET_STORE_ZIP", "13850")
TARGET_STORE_STATE = os.environ.get("SHOPEASE_TARGET_STORE_STATE", "NY")
TARGET_STORE_LATITUDE = os.environ.get("SHOPEASE_TARGET_STORE_LATITUDE", "42.094186")
TARGET_STORE_LONGITUDE = os.environ.get("SHOPEASE_TARGET_STORE_LONGITUDE", "-76.001181")
TARGET_TIMEZONE = os.environ.get("SHOPEASE_TARGET_TIMEZONE", "America/New_York")
